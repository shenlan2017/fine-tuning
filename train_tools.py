...
def setup_everything():
    ...
    parser.add_argument("--train_args_file", type=str, default='train_args/sft/full/qwen2-1.5b-sft-full-tools.json', help="")
...
def load_sft_dataset(args, tokenizer):
    ...
    elif 'qwen-tools' in args.model_name_or_path.lower():
        logger.info('Loading data with QWENToolsDataset')
        train_dataset = UnifiedSFTToolsDataset(args.train_file, tokenizer, args.max_seq_length, template)
    else:
