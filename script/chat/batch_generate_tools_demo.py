...
def get_inference_args():
    ...
    args.add_argument("--model_path", type=str, default="/mapping-data/sharedLLMs/Qwen2-1.5B")
    ...
    args.add_argument("--output_dir", type=str, default='/mapping-data/qianli/firefly/output/firefly-qwen2-1.5b-sft-lora-tools-1800/test_ori')
    ...
    args.add_argument("--max_new_tokens", type=int, default=100)  # raw 0   bs_setting: 40
        ...
        with torch.no_grad():
                ...
                for line in tqdm(f):
                    ...
                    if tools !='[]':
                        ...
                        #     response = output_str .replace("'", '"')
                        #     response = json.loads(response)
                        #     tgt = tgt.replace("'", '"')
                        #     tgt = json.loads(tgt)
                        #     if response['name'] ==tgt['name']:
                        #         acc+=1
                        # else:
