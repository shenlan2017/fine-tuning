...
def register_template(template_name, system_format, user_format, assistant_format, system,  function_format=None,  observation_format=None,stop_word=None):
...
register_template(
    ...
    user_format='<|im_start|>user\n{content}<|im_end|>\n<|im_start|>assistant\n',
    assistant_format='{content}<|im_end|>\n',
    function_format='<|im_start|>function\n{content}<|im_end|>\n',
    observation_format='<|im_start|>observation\n{content}<|im_end|>\n',
